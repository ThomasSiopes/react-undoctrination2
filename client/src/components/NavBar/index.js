                ...
                <Container>
                    <Nav>
                        <div className="text-center" id="banner">
                            ...
                            <Col xs={12} md={12} className="px-1"><Link to={`/`} title="Home" className="navIcon"><img src="/assets/images/thumbnails/undoctrination.png" alt="Logo"/></Link></Col>
                                <Col xs={12} lg={7}>
                                    <Row className="align-items-end">
                                ...
                                <Col xs={12} lg={5}>
                                    <Navbar.Collapse id="main-navbar">
                                        <Row className="mx-auto container mb-2">
                                            <Col xs={12} md={4} lg={6} xl={4} className="nav-link px-2"><Link to={`/freethinkers`}><Button variant={"theme"} className="btn-block"><strong>Freethinkers</strong></Button></Link></Col>
                                            <Col xs={12} md={4} lg={6} xl={4} className="nav-link px-2"><Link to={`/platforms`}><Button variant={"theme"} className="btn-block"><strong>Platforms</strong></Button></Link></Col>
