...
const FooterPage = () => {
    return (
        <Card id="footer-supreme" className="bg-theme text-center text-white mt-4 py-4">
            <Container>
                <Row>
                    <Col xs={6} md={4} className="d-flex font-Lato">
                        <Container className="align-self-center">
                            <Link to={`/`} className="navbar-brand text-white footer-img"><img src="/assets/images/thumbnails/undoctrination_small.png"/></Link>
                        </Container>
                    </Col>
                    <Col xs={6} md={4} className="align-self-center mb-3">
